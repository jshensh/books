<?php
    ...
    function doRollback() {
        ...
        $reQuery->execute(array(
            ":p0"  => $rollbackID["loanID1"],
            ":p1"  => $rollbackID["loanID2"],
            ":p2"  => $rollbackID["transactionsID1"],
            ":p3"  => $rollbackID["transactionsID2"],
            ":p4"  => $rollbackID["lowOut"],
            ":p5"  => $rollbackID["highOut"],
            ":p6"  => $rollbackID["closedOut"],
            ":p9"  => $rollbackID["incomeOut"],
            ":p10" => $rollbackID["expendOut"],
            ":p7"  => strtotime(date("Y-m-d"))
        ));
